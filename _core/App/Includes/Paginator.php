<?php
//https://github.com/dcblogdev/pagination/blob/master/paginator.php
/*
  ...
  public function set_page($page) {
	...
	*/
	...
	public function page_links($path='?',$ext=null)
	{
        ...
        $pagination.= "<li class='page-item disabled'><a class='page-link'>&laquo;</a>"; 
        ...
        $pagination.= "<li class='page-item'><a class='page-link border-0'>...</a></li>";
        ...
        $pagination.= "<li class='page-item disabled'><a class=page-link>&raquo;</a>"; 
		    $pagination.= "</ul>\n";       
		}
